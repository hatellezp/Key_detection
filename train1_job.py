...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='/floyd/input/yolo_weights/yolo_weights.h5'):
...
if __name__ == '__main__':
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='/floyd/input/yolo_weights/yolo_weights.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='/floyd/input/yolo_weights/yolo_weights.h5') # make sure you know what you freeze
